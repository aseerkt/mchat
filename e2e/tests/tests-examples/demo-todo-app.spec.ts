...
//   test.skip('should allow me to mark all items as completed', async ({
//     page,
//   }) => {
//     // Complete all todos.
...
//   test.skip('should allow me to clear the complete state of all items', async ({
//     page,
//   }) => {
...
//   test.skip('complete all checkbox should update state when items are completed / cleared', async ({
//     page,
//   }) => {
//     const toggleAll = page.getByLabel('Mark all as complete')
//     await toggleAll.check()
...
//   test.skip('should allow me to un-mark items as complete', async ({
//     page,
//   }) => {
//     // create a new todo locator
//     const newTodo = page.getByPlaceholder('What needs to be done?')
...
//   test.skip('should remove the item if an empty text string was entered', async ({
//     page,
//   }) => {
//     const todoItems = page.getByTestId('todo-item')
//     await todoItems.nth(1).dblclick()
...
//   test.skip('should display the current number of todo items', async ({
//     page,
//   }) => {
//     // create a new todo locator
//     const newTodo = page.getByPlaceholder('What needs to be done?')
...
//   test.skip('should be hidden when there are no items that are completed', async ({
//     page,
//   }) => {
//     await page.locator('.todo-list li .toggle').first().check()
//     await page.getByRole('button', { name: 'Clear completed' }).click()
...
//   test.skip('should highlight the currently applied filter', async ({
//     page,
//   }) => {
